...
class CreationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creation" do
    assert_difference('Creation.count') do
      post creations_url, params: { creation: { name: @creation.name, original_id: @creation.original_id, user_id: @creation.user_id } }, as: :json
    end
  ...
  test "should update creation" do
    patch creation_url(@creation), params: { creation: { name: @creation.name, original_id: @creation.original_id, user_id: @creation.user_id } }, as: :json
    assert_response 200
  end
